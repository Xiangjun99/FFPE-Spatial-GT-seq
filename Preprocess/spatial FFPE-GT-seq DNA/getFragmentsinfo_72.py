...
def process_file(args_tuple):
    ...
    if filename.endswith('.bam') and '+' in filename:
        ...
        # For 72×72 grid
        idx1 = 73 - int(cell_name_dic[part1])
...
# 72 barcodes mapping
cell_name_dic = {
    'AACGTGAT': '1',  'GCGAGTAA': '2',  'ATGCCTAA': '3',  'GCTAACGA': '4',
    'ACCACTGT': '5',  'ACATTGGC': '6',  'CAGATCTG': '7',  'CATCAAGT': '8',
    'CGCTGATC': '9',  'ACAAGCTA': '10', 'CTGTAGCC': '11', 'AGTACAAG': '12',
    'AACAACCA': '13', 'AACCGAGA': '14', 'AACGCTTA': '15', 'AAGACGGA': '16',
    'AAGGTACA': '17', 'ACACAGAA': '18', 'ACAGCAGA': '19', 'ACCTCCAA': '20',
    'ACGCTCGA': '21', 'ACGTATCA': '22', 'ACTATGCA': '23', 'AGAGTCAA': '24',
    'AGATCGCA': '25', 'AGCAGGAA': '26', 'AGTCACTA': '27', 'ATCCTGTA': '28',
    'ATTGAGGA': '29', 'CAACCACA': '30', 'GACTAGTA': '31', 'CAATGGAA': '32',
    'CACTTCGA': '33', 'CAGCGTTA': '34', 'CATACCAA': '35', 'CCAGTTCA': '36',
    'CCGAAGTA': '37', 'CCGTGAGA': '38', 'CCTCCTGA': '39', 'CGAACTTA': '40',
    'CGACTGGA': '41', 'CGCATACA': '42', 'CTCAATGA': '43', 'CTGAGCCA': '44',
    'CTGGCATA': '45', 'GAATCTGA': '46', 'CAAGACTA': '47', 'GAGCTGAA': '48',
    'GATAGACA': '49', 'GCCACATA': '50', 'GCTCGGTA': '51', 'GGAGAACA': '52',
    'GGTGCGAA': '53', 'GTACGCAA': '54', 'GTCGTAGA': '55', 'GTCTGTCA': '56',
    'GTGTTCTA': '57', 'TAGGATGA': '58', 'TATCAGCA': '59', 'TCCGTCTA': '60',
    'TCTTCACA': '61', 'TGAAGAGA': '62', 'TGGAACAA': '63', 'TGGCTTCA': '64',
    'TGGTGGTA': '65', 'TTCACGCA': '66', 'AACTCACC': '67', 'AAGAGATC': '68',
    'AAGGACAC': '69', 'AATCCGTC': '70', 'AATGTTGC': '71', 'ACACGACC': '72',
    'AAACATCG': '73', 'AGTGGTCA': '74'
}
